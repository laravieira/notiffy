...
<body class="light">
                    ...
                    <select name="newsletter" id="newsletter">
                        <datalist>
                            <?php $__currentLoopData = $newsletters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsletter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option title="<?php echo e($newsletter['description']); ?>" id="<?php echo e($newsletter['id']); ?>" value="<?php echo e($newsletter['id']); ?>"><?php echo e($newsletter['name']); ?></option>
    ...
    <div class="footer footer-left">
        <p><?php echo e(Notiffy\Notiffy::NAME); ?>&nbsp;<?php echo e(Notiffy\Notiffy::VERSION); ?></p>
    </div>
    <div class="footer footer-right">
        <p>2018 - <?php echo e(date('Y')); ?> | &copy; by <a href="https://laravieira.me" title="Vititar página pessoal">Lara Vieira</a>.</p>
    </div>
    <script>
...
</html><?php /**PATH C:\Projects\Notiffy\src\Notiffy\views/home.blade.php ENDPATH**/ ?>